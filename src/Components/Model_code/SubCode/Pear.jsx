...
const showPEHCT  = isHalo && prongTips === 'Claw'
const showPEHRT  = isHalo && prongTips === 'Rounded'
const showPEHPCT = isHalo && prongTips === 'PetiteClaw'
const showPEHTT  = isHalo && prongTips === 'Tab'
